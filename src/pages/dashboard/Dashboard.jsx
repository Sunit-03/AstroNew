...
import Form2 from './duty/Form2';
import Form3 from './records/Form3';
import Form4 from './aiSystem/Form4';
import Form5 from './dataAnalysis/Form5';
...
const Dashboard = () => {
  ...
  return (
    <div className='flex flex-col gap-4 md:gap-8 bg-white p-2 w-full md:w-4/5 mx-auto h-[100vh] md:h-fit overflow-y-auto'>
    {/* <section>
